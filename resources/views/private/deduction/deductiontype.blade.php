    ...
    <div class="col-xs-5 col-sm-12 col-md-12 col-lg-6 px-2">
      <div class="row">
        <div class="col-sm-12 mb-3">
          <button class="btn w-100" style="color:white; background-color: #CF8029;" data-bs-toggle="modal" data-bs-target="#addModal" type="submit" id="button-addon2">
          ...
          <div class="card-border shadow mb-1 p-2 bg-white h-100">
            ...
            <div class="row">
              <div class="col" style="margin-left:16px">
                <div style="margin-top: 15px;" class="page_showing" id="tbl_showing"></div>
              </div>
            </div>
            <div class="row mx-1">
              <div class="col">
                <ul style="display:flex;justify-content:flex-start;" class="pagination pagination-sm flex-sm-wrap" id="tbl_pagination">
                </ul>
              </div>
            </div>
          </div>
                ...
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row">
                    <div class="col-12 mb-3">
                      ...
                      <input id="deduction_name" name="deduction_name" type="text" class="form-control" placeholder="Deduction Name">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12 mb-3">
                      ...
                      <input id="deduction_amount" name="deduction_amount" type="text" class="form-control" placeholder="Amount">
                    </div>
                  </div>

                  <div class="row pt-3">
                    <div class="col">
                      <button type="button" id="close" class="btn  w-100" style="color:white; background-color:#A4A6B3; ">Close</button>
                    </div>
                    <div class="col">
          ...
          <div class="card-border shadow mb-1 p-2 bg-white h-100">
            <div class="row px-4 py-4" id="header">
              <div class="col-md-12 px-2 w-100">
                ...
                <div class="row">
                  <div class="col mb-3">
                    <label for="edit_deduction_name" style="color:#A4A6B3">Deduction Name</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <div class="row pt-3 pb-3 px-3">
          ...
          <div class="col-6">
            <button type="button" id="deductionType_delete" class="btn btn-danger w-100">Confirm</button>
          </div>
        </div>
      </div>
    </div>
