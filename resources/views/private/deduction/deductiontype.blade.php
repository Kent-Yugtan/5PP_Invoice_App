  ...
  <div class="row">
    ...
    <div class="col-xs-5 col-sm-12 col-md-12 col-lg-6 px-2">
      ...
      <div class="row pt-3 ">
        ...
        <div class="col-sm-6 ">
          <button type="button" class="btn w-100" style=" color:white; background-color: #CF8029;" id="button_search">Search</button>
        </div>
      </div>
        ...
        <div class="modal-body ">
          <div class="row">
            ...
            <form id="deductiontype_store">
              ...
              <div class="row mt-3">
                <div class="col">
                  <button type="button" id="close" class="btn btn-secondary w-100" style=" color:#CF8029; background-color:white; ">Close</button>
                </div>
                <div class="col">
