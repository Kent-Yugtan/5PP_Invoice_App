...
<div class="container-fluid px-4" id="loader_load">
  ...
  <div class="row">
    <div class="col-xl-3 col-md-3 pb-4">
      <div class="card-hover shadow card-border p-2 bg-white" style="max-width: 40rem;">
    ...
    <div class="col-xl-3 col-md-3 pb-4">
      <div class="card-hover shadow card-border p-2  bg-white rounde-2" style="max-width: 40rem;">
        <div class="text-center " style="border-bottom: none;color: #A4A6B3; ">
          ...
          <form id="quick_invoice">
            <div class="row">
              ...
              <div class="col-xl-6 mb-4">
                ...
                <input type="text" placeholder="Due Date" onblur="(this.type='text')" id="due_date" name="due_date" class="form-control">
              </div>
            </div>
            <div class="row">
              <div class="col-xl-6 mb-4">
  ...
  <div class="row">
    <div class="col-xl-6 pb-4">
      <div class="card-border shadow p-2 bg-white h-100">
        ...
        <div class="row mx-1">
          <div class="col">
            <ul style="display:flex;justify-content:flex-start;" class="pagination pagination-sm flex-wrap" id="tbl_pagination_pendingInvoice">
            </ul>
          </div>
        </div>
        <!-- </div> -->
    ...
    <div class="col-xl-6 pb-4">
      <div class="card-border shadow p-2  bg-white h-100">
        ...
        <div class="row mx-1">
          <div class="col">
            <ul style="display:flex;justify-content:flex-start;" class="pagination pagination-sm flex-wrap" id="tbl_pagination_overdueInvoice">
            </ul>
          </div>
        </div>
      </div>
