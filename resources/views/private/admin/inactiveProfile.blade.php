          ...
          <form id="ProfileUpdate">
            <div class="row pt-3">
              ...
              <div class="col-md-7 col-lg-7 pt-3 mb-3">
                ...
                <div class="row">
                  <div class="col mb-3">
                    <label for="first_name" style="color: #A4A6B3;">*Firstname</label>
              ...
              <div class="col-md-6 px-2 w-100">
                <div class="card shadow p-2 mb-5 bg-white rounded">
                  ...
                  <div class="row px-4 pb-4 pt-4" id="header">
                    ...
                    <div class="col-6 mb-3">
                      <div class="pb-3">
                        <button type="buttono" id="save" class="btn  w-100" style="color:White; background-color:#CF8029;">Save</button>
                      </div>
                    </div>
              ...
              <div class="row px-4 py-4" id="header">
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row pt-3">
                    ...
                    <div class="col">
                      <button type="button" data-bs-toggle="modal" data-bs-target="#deleteModal" id="deleteProfileDeduction" class="btn btn-danger w-100" style="color:White; background-color:#dc3545;" disabled>Delete</button>
                    </div>
                    <div class="col">
                      <button type="submit" class="btn  w-100" style="color:White; background-color:#CF8029; " data-bs-dismiss="modal" disabled>Update</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row px-4 py-4" id="header">
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col">
                      <button type="submit" id="update" class="btn  w-100" style="color:White; background-color:#CF8029; " disabled="true">Update</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            if (data.success) {
              if (data.data.profile_deduction_types.length > 0) {
                data.data.profile_deduction_types.map((item) => {
                  let label = '<label>';
                  label +=
                    "<button type='button' data-bs-toggle='modal'  style='width:150px;background-color:#CF8029;color:white;' data-bs-target='#ProfileDeductioneditModal' id='editProfileDeduction' class='editProfileDeduction btn my-2 mx-2' value=" +
