                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="email" name="email" type="email"
                      class="form-control @error('email') is-invalid @enderror" placeholder="Email" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="bank_address" name="bank_address" type="text"
                      class="form-control @error('bank_address') is-invalid @enderror" id="formGroupExampleInput2"
              ...
              <div class="row mx-2 mb-3">
                <div class="col-4">
                  <button style="color:white; background-color: #CF8029;" data-bs-toggle="modal"
                    ...
                    class="btn form-check-inline pe-3 w-100" disabled><i class="fa fa-plus pe-1"></i>Add
                    Invoice</button>
                </div>
                <div class="col-4">
                ...
                <div class="card shadow p-2 mb-5 bg-white rounded">
                  ...
                  <div class="row px-4 pb-4 pt-4" id="header">
                    ...
                    <div class="col-6 mb-3">
                      <div class="pb-3">
                        <button type="button" class="btn  w-100" style=" color:#CF8029; background-color:white; "
                  ...
                  <div class="row pt-3">
                    ...
                    <div class="col">
                      <button type="button" data-bs-toggle="modal" data-bs-target="#deleteModal"
                        ...
                        style="color:White; background-color:#dc3545;" disabled>Delete</button>
                    </div>
                    <div class="col">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col">
                      <button type="submit" id="update" class="btn  w-100"
                        style="color:White; background-color:#CF8029; " disabled="true">Update</button>
                    </div>
                  </div>
                </div>
              </div>
