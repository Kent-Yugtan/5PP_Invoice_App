              ...
              <div class="col-md-6 px-2 w-100">
                <div class="card shadow p-2 mb-5 bg-white rounded">
                  ...
                  <div class="row px-4 pb-4 pt-4" id="header">
                    ...
                    <div class="col-6 mb-3">
                      <div class="pb-3">
                        <button type="buttono" id="save" class="btn btn-secondary w-100"
            ...
            <form id="deductiontype_store" method="POST" action="javascript:void(0)" class="row g-3 needs-validation"
              ...
              <div class="form-group">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col">
                    <button type="submit" id="createDeduction_button" class="btn btn-secondary w-100"
                ...
                <div class="row mt-3">
                  ...
                  <div class="col">
                    <button type="submit" class="btn btn-secondary w-100"
                      style="color:White; background-color:#CF8029; " data-bs-dismiss="modal" disabled>Update</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <div class="row">
            ...
            <form id="update_invoice_status">
              ...
              <div class="form-floating form-group mt-3">
                ...
                <label for="select_invoice_status">Status Name</label>
              </div>
