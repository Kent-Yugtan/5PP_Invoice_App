    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-5">
      <div class="card shadow p-2 mb-1 bg-white rounded">
        <div class="card-header">
          <h1 class="mt-0"> <i style="color:#CF8029" class="fas fa-users"></i> Add Profile</h1>
        </div>
      </div>
    </div>
  </div>
            ...
            <form id="ProfileStore">
              <div class="row pt-3">
                ...
                <div class="col-md-7 pt-3 mb-3">
                  ...
                  <label style="color: #A4A6B3;" for="first_name"></label>

                  <input id="last_name" name="last_name" type="text" class="form-control" placeholder="*Last Name">
                  <label for="last_name" style="color: #A4A6B3;"></label>
                </div>
              </div>
              <div class="row row_email_adminProfile">
                <div class="col">
                  <input id="email" name="email" type="email" class="form-control" placeholder="*Email">
                  <label for="email" style="color: #A4A6B3;"></label>

                  <input id="username" name="username" type="text" class="form-control" placeholder="*Username">
                  <label for="username" style="color: #A4A6B3;"></label>

                  <input id="password" name="password" type="password" class="form-control" placeholder="*Password">
                  <label id="password" style="color: #A4A6B3;"></label>
                  ...
                  <label for="bank_name" style="color: #A4A6B3;"></label>


                  <input id="bank_location" name="bank_location" type="text" class="form-control"
                  ...
                  <input name="date_hired" type="text" onblur="(this.type='text')" class="form-control" id="date_hired"
                    placeholder="Date Hired">
                  <label for="city" style="color: #A4A6B3;"></label>

                  <div class="col mb-3">
                    <select class="form-select" data-placeholder="Choose deduction" multiple id="select2Multiple">
                    </select>
                  </div>
