              ...
              <div class="col-md-7 col-lg-7 pt-3 mb-3">
                ...
                <div class="row">
                  <div class="col mb-3">
                    ...
                    <input id="first_name" name="first_name" type="text" class="form-control" placeholder="Firstname" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <input id="last_name" name="last_name" type="text" class="form-control" placeholder="Lastname" disabled="true">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="bank_address" name="bank_address" type="text" class="form-control" placeholder="Bank Address" disabled="true">
                  </div>
                </div>
                    ...
                    <div class="col-12 mb-3">
                      <div class="row">
                        <div class="col ">
                          ...
                          <input id="description" placeholder="Description" name="description" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      <div class="form-group">
                        ...
                        <input type="text" id="edit_profileDeductionType_name" name="edit_profileDeductionType_name" class="form-control">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      ...
                      <input id="edit_profileDeductionType_amount" name="edit_profileDeductionType_amount" type="text" class="form-control" placeholder="Amount">
                    </div>
                  </div>
            ...
            if (data.success) {
              ...
              if (data.data.data.length > 0) {
                ...
                if (data.data.links.length) {
                  ...
                  let PreviousPage = data.data.links[0];
                  if (PreviousPage.label == '&laquo; Previous' && PreviousPage.url == null) {
                    $('#tbl_pagination_deduction .page-item:first-child').addClass('disabled');
                  }
                }
