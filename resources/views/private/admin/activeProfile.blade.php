...
<div class="container-fluid px-4" id="loader_load">
  ...
  <div class="row pb-3">
    <div class="col-md-12 col-lg-12 col-xl-5 pb-4">
        ...
        <div class="card-body">
          ...
          <form id="ProfileUpdate">
            <div class="row pt-3">
              ...
              <div class="col-md-7 col-lg-7 pt-3 mb-3">
                <div class="row">
                  <div class="col mb-3">
                ...
                <div class="row">
                  <div class="col mb-3">
                    ...
                    <input id="first_name" name="first_name" type="text" class="form-control" placeholder="First Name" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <input id="last_name" name="last_name" type="text" class="form-control" placeholder="Last Name" disabled="true">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12 mb-3">
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="email" name="email" type="email" class="form-control" placeholder="Email" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="username" name="username" type="text" class="form-control" placeholder="Username" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <select class="form-select" id="position" name="position" defaultValue="select" disabled="true">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="phone_number" name="phone_number" type="text" class="form-control" placeholder="Phone Number" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="address" name="address" type="text" class="form-control" placeholder="Address" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="province" name="province" type="text" class="form-control" placeholder="Province" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="city" name="city" type="text" class="form-control" placeholder="City" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="zip_code" name="zip_code" type="text" class="form-control" placeholder="Zip Code" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="acct_no" name="acct_no" type="text" class="form-control" placeholder="Account Number" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="acct_name" name="acct_name" type="text" class="form-control" placeholder="Account Name" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <select class="form-select" id="bank_name" name="bank_name" aria-label="Default select example" disabled="true">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="bank_location" name="bank_location" type="text" class="form-control" placeholder="Bank Address" disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="gcash_no" name="gcash_no" type="text" class="form-control" placeholder="Gcash Number" disabled="true">
                  </div>
                </div>
    ...
    <div class="col-md-12 col-lg-12 col-xl-7 pb-4">
      <div class="card-border shadow mb-1 p-2 bg-white h-100">
        <!-- <div class="card-header">Profile Information</div> -->
        <div class="row">
          <div class="col">
            <ul class="nav nav-pills mb-3" style="padding-left: 20px;padding-right: 20px;" id="pills-tab" role="tablist">
        ...
        <div class="form-group has-search">
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-invoice" role="tabpanel" aria-labelledby="pills-invoice-tab">
              ...
              <div class="row mx-2">
                <div class="col">
                  <div style="margin-left: -4px;" class="page_showing" style="color:black !important;" id="tbl_showing_invoice"></div>
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="pills-deduction" role="tabpanel" aria-labelledby="pills-deduction-tab">
              ...
              <div class="row mx-2">
                <div class="col">
                  <div style="margin-left: 3px;" class="page_showing" id="tbl_showing_deduction"></div>
                </div>
              </div>
              <div class="row mx-1">
                <div class="col">
                ...
                <div class="card-border shadow mb-1 p-2 bg-white h-100">
                  ...
                  <div class="row px-4 pb-4 pt-4" id="header">
                    ...
                    <div class="col-12 mb-3">
                      <div class="row">
                        <div class="col ">
                          <label for="invoice_description" style="color:#A4A6B3">Description</label>
                    ...
                    <div class="col-12 mb-3">
                      <div class="row">
                        <div class="col-12" style="justify-content:end;display:flex">
                          <div class="form-group">
                            <!-- border-style:none -->
                            <label for="subtotal" style="color:#A4A6B3">Subtotal ($): </label>
            ...
            <div class="card-border shadow mb-1 p-2 bg-white h-100">
              <div class="row px-4 py-4" id="header">
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row mt-3">
                    <div class="col">
                      <button type="button" class="btn w-100" style="background-color:#A4A6B3;color:white" data-bs-dismiss="modal">Close</button>
                    </div>
                    <div class="col">
  ...
  $(document).ready(function() {
    ...
    function show_Profilededuction_Table_Active(filters) {
      ...
      if (urlSplit.length === 5) {
        ...
        $('#dataTable_deduction tbody').empty();
        axios.get(`${apiUrl}/api/admin/show_Profilededuction_Table_Active?${new URLSearchParams(filter)}`, {
            headers: {
              Authorization: token,
            },
          })
            ...
            if (data.success) {
              ...
              if (data.data.data.length > 0) {
                ...
                if (data.data.links.length) {
                  let lastPage = data.data.links[data.data.links.length - 1];
                  if (lastPage.label == 'Next &raquo;' && lastPage.url == null) {
                    $('#tbl_pagination_deduction .page-item:last-child').addClass('disabled');
                  }
                }
            ...
            if (data.success) {
              if (data.data.profile_deduction_types.length > 0) {
                data.data.profile_deduction_types.map((item) => {
                  let label = '<label>';
                  label +=
                    "<button type='button' data-bs-toggle='modal' style='width:150px;background-color:#CF8029;color:white;' data-bs-target='#ProfileDeductioneditModal' id='editProfileDeduction' class='btn editProfileDeduction my-2 mx-2' value=" +
