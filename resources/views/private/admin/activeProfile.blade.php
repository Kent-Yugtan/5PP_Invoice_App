  ...
  <div class="row pb-3">
          ...
          <form id="ProfileUpdate">
            <div class="row pt-3">
              ...
              <div class="col-md-7 col-lg-7 pt-3 mb-3">
                <div class="row">
                  <div class="col mb-3">
                    <input class="form-check-input" type="checkbox" id="profile_status" name="profile_status"
                      disabled="true">
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="acct_no" name="acct_no" type="text" class="form-control" placeholder="Account Number"
                      disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="acct_name" name="acct_name" type="text" class="form-control" placeholder="Account Name"
                      disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="bank_address" name="bank_address" type="text" class="form-control"
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="gcash_no" name="gcash_no" type="text" class="form-control" placeholder="Gcash Number"
                      disabled="true">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <input id="date_hired" name="date_hired" type="text" onblur="(this.type='text')"
                      class="form-control" placeholder="Date Hired" disabled="true">
                  </div>
                </div>
                <div class="row mt-3 mb-3">
                  <div class="col-6">
                    <button type="button" id="edit_profile" style="width:100%;color:white; background-color: #A4A6B3;"
                      class="btn">Edit
                      Profile</button>
                    <button type="button" id="cancel_edit_profile"
                      style="width:100%;color:white; background-color: #A4A6B3;" class="btn d-none">Cancel</button>
                  </div>
                  <div class="col-6">
    ...
    <div class="col-md-12 col-lg-12 col-xl-7">
      <div class="card-border shadow mb-1 p-2 bg-white h-100">
        ...
        <div class="row">
          <div class="col">
            <ul class="nav nav-pills mb-3" style="padding-top:16px;padding-left: 20px;padding-right: 20px;"
              ...
              <li class="nav-item" role="presentation" style="width:50%">
                <a style="width:100%" href="#pills-deduction" data-bs-toggle="pill" data-bs-target="#pills-deduction"
                  class="nav-link text-center" data-toggle="tab">Profile
                  Deductions</a>
              </li>
            </ul>
          </div>
        ...
        <div class="form-group has-search">
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-invoice" role="tabpanel"
              ...
              <div class="row mx-2">
                <div class="col">
                  <div style="margin-top: 10px;margin-left: 0px;" class="page_showing" style="color:black !important;"
            ...
            <div class="tab-pane fade" id="pills-deduction" role="tabpanel" aria-labelledby="pills-deduction-tab">
              ...
              <div class="row mx-2">
                <div class="col">
                  <div style="margin-top:19px;margin-left: 5px;" class="page_showing" id="tbl_showing_deduction"></div>
                </div>
              </div>
              <div class="row mx-2">
                <div class="col">
                  <ul style="margin-left: 6px;display:flex;justify-content:flex-start;"
                      ...
                      <div class="row">
                        <div class="col-4 md-2 w-100">
                          <div class="form-group">
                            <button class="btn" style="width:100%;color:white; background-color: #CF8029;"
                              id="add_item">Add
                              Item</button>
                          </div>
                        </div>
                        ...
                        <div class="col-12" style="justify-content:end;display:flex">
                          <div class="form-group">
                            ...
                            <input type="text"
                              ...
                              name="sub_total" id="sub_total" class="form-control no-outline sub_total" readonly
                              tabindex="-1">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col">
                          <div class="form-group">
                            ...
                            <input type="text" id="dollar_amount"
                              ...
                              class="text-start form-control dollar_amount" disabled />
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="form-group">
                            <label for="peso_rate" style="color:#A4A6B3">Peso Rate
                              (Php)</label>
                            <input type="text" style="font-weight: bold;border:none;background-color:white"
                              onkeypress="return onlyNumberKey(event)" id="peso_rate" class="text-start form-control"
                              disabled />
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-group">
                            ...
                            <input type="text" style="font-weight: bold;border:none;background-color:white"
                              ...
                              class="text-start form-control converted_amount" disabled />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      <div class="form-group">
                        ...
                        <input type="text" id="edit_profileDeductionType_name" name="edit_profileDeductionType_name"
                          class="form-control">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col mb-3">
                      ...
                      <input id="edit_profileDeductionType_amount" name="edit_profileDeductionType_amount" type="text"
            ...
            <div class="card-border shadow mb-1 p-2 bg-white h-100">
              <div class="row px-4 py-4" id="header">
                <div class="col-md-12 px-2 w-100">
                  ...
                  <div class="row mt-3">
                    <div class="col">
                      <button type="button" class="btn w-100" style="background-color:#A4A6B3;color:white"
                        data-bs-dismiss="modal">Close</button>
                    </div>
                    <div class="col">
...
$(document).ready(function() {
  ...
  $('#deductiontype_store').validate({
    rules: {
      createDeduction_deduction_name: {
        required: true,
      },
      createDeduction_deduction_amount: {
        required: true,
      },
    },
  ...
  $('#ProfileDeductiontype_update').validate({
    rules: {
      edit_profileDeductionType_name: {
        required: true,
      },
      edit_profileDeductionType_amount: {
        required: true,
      },
    },
    errorClass: 'is-invalid',
