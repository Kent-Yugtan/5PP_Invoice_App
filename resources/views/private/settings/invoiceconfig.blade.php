...
<div class="container-fluid px-4" id="loader_load">
  ...
  <div class="row">
    <div class="col-xl-12 col-md-12 py-4">
      <span class="fs-3 fw-bold"> Invoice Configuration</span>
    </div>
  </div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-8 mb-3">
      <div class="card-border shadow p-2 bg-white h-100">
        <div class="header mb-3">
          <span class="fs-5"> View Invoice Information</span>
        </div>
        ...
        <div class="card-body ">
          ...
          <div class="row pt-3">
            <div class="col" style="display: flex; align-content: stretch; justify-content: space-between;">
              ...
              <div>
                <ul style="display:flex;align-items:center" class="pagination pagination-sm" id="tbl_pagination"></ul>
              </div>
            </div>
          </div>
        </div>
