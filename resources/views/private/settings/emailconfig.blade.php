    ...
    <div class="col-xl-12">
      <div class="card shadow p-2 mb-1 bg-white rounded">
        <div class="card-header">
          <h1 class="mt-0"> <i style="color:#CF8029" class="fas fa-cogs"></i> Email Configuration</h1>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <label for="fullname" style=" color: #A4A6B3;"></label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <label for="email_address" style=" color: #A4A6B3;"></label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <label for="title" style=" color: #A4A6B3;"></label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <label for="status" style=" color: #A4A6B3;"></label>
                  </div>
                </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form id="emailconfigs_update">
                      ...
                      <input id="edit_fullname" name="edit_fullname" type="text" class="form-control"
                        placeholder="Fullname">
                      <label for="edit_fullname"></label>

                      <input id="edit_email_address" name="edit_email_address" type="text" class="form-control"
                        placeholder="Email Address">
                      <label for="edit_email_address"></label>

                      <input id="edit_title" name="edit_title" type="text" class="form-control" placeholder="Position">
                      <label for="edit_title" style="color: #A4A6B3;"></label>
                      ...
                      <label for="edit_status" style=" color: #A4A6B3;"></label>
