...
<div class="container-fluid px-4" id="loader_load">
  ...
  <div class="row px-4 pb-4">
    <div class="col-lg-8 col-xl-9 col-xxl-6  px-2 editInvoiceData">
              ...
              <table class="table" id="table_invoiceItems" style="table-layout: fixed;">
                <thead class="thead-dark" style="border-radius: 5px; background-color: black; color: white;">
                  <tr>
                    ...
                    <th style="width: 15%;text-align: end;">Quantity</th>
                    <th style="width: 15%;text-align: end;">Rate</th>
            ...
            <div class="col-md-7 col-sm-12">
              ...
              <div class="row">
                <div class="col-md-8 col-sm-8">
                  <label class="text-muted fw-bold">Converted Amount: <label class="text-muted" id="peso_rate"></label></label>
                </div>
    ...
    <div class="col-lg-4 col-xl-3 col-xxl-4 px-2 editInvoiceButton">
      <div class="card shadow bg-white rounded py-3">
        <div class="row px-3 py-1">
          <div class="col-6">
            <button type="button" data-bs-toggle="modal" data-bs-target="#activeModal" class="btn btn-secondary w-100" style="color: White; background-color: #CF8029;">Active</button>
          </div>
          <div class="col-6">
            <button type="button" data-bs-toggle="modal" data-bs-target="#inactiveModal" class="btn btn-secondary w-100" style="color: White; background-color: CF8029;">Inactive</button>
          </div>
        </div>

        <div class="row px-3 pt-3 pb-1">
          <div class="col-12 w-100">
            <button type="button" data-bs-toggle="modal" data-bs-target="#paidModal" class="btn btn-secondary w-100" style="color: White; background-color: #198754;">Paid Invoice</button>
          </div>
        </div>

        <div class="row px-3 py-1">
          <div class="col-12 w-100">
            <button type="button" data-bs-toggle="modal" data-bs-target="#cancelModal" class="btn btn-secondary w-100" style="color: White; background-color: gray;">Cancel Invoice</button>
          </div>
        </div>

        <div class="row px-3 py-1">
          <div class="col-12 w-100">
            <button type="button" id="delete_button" data-bs-toggle='modal' data-bs-target='#deleteModal' class="btn btn-secondary w-100" style="color: White; background-color: red;">Delete
              Invoice</button>
          </div>
        </div>
    ...
    <div class="modal-content" style="top:30px;">
      ...
      <div class="modal-body text-center">
        ...
        <div class="row pt-3 pb-3 px-3">
          ...
          <div class="col-6">
            <button type="button" id="active_button" class="btn btn-secondary w-100" style="color:white;background-color: #CF8029;">Yes</button>
          </div>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="inactiveModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" style="top:30px;">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Confirmation</h5>
      ...
      <div class="modal-body text-center">
        ...
        <div class="row pt-3 pb-3 px-3">
          ...
          <div class="col-6">
            <button type="button" id="inactive_button" class="btn btn-secondary w-100" style="color:white;background-color: #CF8029;">Yes</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content" style="top:30px;">
      ...
      <div class="modal-body text-center">
        ...
        <div class="row pt-3 pb-3 px-3">
          ...
          <div class="col-6">
            <button type="button" id="paid_button" class="btn btn-secondary w-100" style="color:white;background-color: #CF8029;">Yes</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content" style="top:30px;">
      ...
      <div class="modal-body text-center">
        ...
        <div class="row pt-3 pb-3 px-3">
          ...
          <div class="col-6">
            <button type="button" id="cancelled_button" class="btn btn-secondary w-100" style="color:white;background-color: #CF8029;">Yes</button>
          </div>
        </div>
      </div>
    </div>
                        ...
                        <div class="col">
                          <div class="form-group">
                            <label class="formGroupExampleInput2">Peso Rate
                              (Php)</label>
                            <input type="text" style="font-weight: bold;border:none; text-align:right;background-color:white" onkeypress="return onlyNumberKey(event)" id="edit_peso_rate" class="form-control" disabled />
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-group">
                            <label class="formGroupExampleInput2" for="form3Example2">Converted
                              Amount (Php)</label>
                            <input type="text" style="font-weight: bold;border:none; text-align:right;background-color:white" onkeypress="return onlyNumberKey(event)" id="converted_amount" class="form-control" disabled />
                          </div>
                        </div>
                      </div>
                    </div>
