                    ...
                    <div class="card-body">
                        ...
                        <form id="ProfileUpdate" class="g-3 needs-validation" novalidate>
                            <div class="row pt-3">
                                ...
                                <input type="text" class="form-control"id="user_id" value="{{ session('data')->id }}"
                                    hidden>
                                <input type="text" class="form-control" id="profile_id_show" hidden>
                                ...
                                <div class="tab-pane fade" id="pills-deduction" role="tabpanel"
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-1"> --}}
                                            ...
                                            {{-- modal-customize-create-deduction --}}
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-lg-4 bottom20"
                                                            ...
                                                            <div>
                                                                <label style="color:#A4A6B3">Discount Type
                                                                </label>
                                                                <br>
                                                        ...
                                                        <div class="col-lg-4 bottom20">
                                                            <div id="col_discount_amount" class="d-none">
                                                                ...
                                                                <input type="text" step="any"
                                                                    ...
                                                                    id="discount_amount" class="form-check-input"
                                                                    maxlength="6" />
                                                            </div>
                                                        </div>
