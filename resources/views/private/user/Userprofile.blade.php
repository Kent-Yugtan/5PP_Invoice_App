          ...
          if (data.success) {
            if (data.data.profile_deduction_types.length > 0) {
              data.data.profile_deduction_types.map((item) => {
                ...
                label +=
                  "<button type='button' data-bs-toggle='modal' style='width:150px;' data-bs-target='#ProfileDeductioneditModal' id='editProfileDeduction' class='editProfileDeduction btn  my-2 mx-2' value=" +
