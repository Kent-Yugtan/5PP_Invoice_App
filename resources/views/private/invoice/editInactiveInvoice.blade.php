    ...
    <div class="col-lg-4 col-xxl-4 pb-4 h-50">
      <div class="card-border shadow mb-1 p-2 bg-white ">
        <div class="card-body">
          ...
          <div class="row mb-3">
            <div class="col-12 w-100">
              <button type="button" data-bs-toggle="modal" data-bs-target="#paidModal" class="btn  w-100"
          ...
          <div class="row mb-3">
            <div class="col-12 w-100">
              <button type="button" data-bs-toggle="modal" data-bs-target="#cancelModal" class="btn  w-100"
                style="color: White; background-color:#A4A6B3;">Cancel Invoice</button>
            </div>
          </div>
          ...
          <div class="row mb-3">
            <div class="col-12 w-100">
              <button type="button" id="delete_button" data-bs-toggle='modal' data-bs-target='#deleteModal'
                class="btn  w-100" style="color: White; background-color: red;">Delete
                Invoice</button>
            </div>
          </div>
          ...
          <div class="row pb-4">
            <div class="col-12 w-100 ">
              <button type="button" id="edit_invoice" data-bs-toggle="modal" data-bs-target="#updateModal"
                class="btn  w-100" style="color: White; background-color: #CF8029;">Edit
                Invoice</button>
            </div>
          </div>
        </div>
                        ...
                        <div class="col-12" style="justify-content:end;display:flex">
                          <div class="form-group">
                            ...
                            <input type="text"
                              ...
                              name="subtotal" id="subtotal" class="form-control no-outline subtotal" readonly>
                          </div>
                        </div>
                      </div>
                    </div>
