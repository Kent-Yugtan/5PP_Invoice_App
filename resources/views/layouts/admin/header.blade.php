<nav class="sb-topnav navbar navbar-expand navbar-light bg-light">
  ...
  <!-- Navbar Brand-->
  <a class="navbar-brand" style=width:220px href="{{url('admin/dashboard')}}">Invoicing App</a>
  <!-- Sidebar Toggle-->
  ...
  <div style="width: 100%;
    ...
    <div class="form-inline ms-auto me-md-3 my-2 my-md-0">
      ...
      <span class="me-5" style="color:#A4A6B3">|</span>
    </div>
