    ...
    <div class="col-md-4 offset-md-4" style="margin-top: 45px;">
      ...
      <form id="resetPassword" autocomplete="off">
        ...
        <div class="form-group mb-3">
          ...
          <input type="email" class="form-control" id="email_address" name="email_address" placeholder="Enter email address" disabled required value="{{ $email_address ?? old('email_address') }}">
        </div>
        <div class="form-group mb-3">
        ...
        <div class="form-group mb-3">
          <button type="submit" id="confirm" style="width:100%;color:white; background-color: #CF8029;" class="btn">Reset
            password</button>
        </div>
