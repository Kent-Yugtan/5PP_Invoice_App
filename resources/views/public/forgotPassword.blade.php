...
<div class="container">
  <div class="row">
    <div class="col-md-4 offset-md-4" style="margin-top: 45px;">
      ...
      <hr>
      <form id="forgotPassword" autocomplete="off class=" row g-2 needs-validation">
        ...
        <div class="form-group mt-2">
          <button type="submit" id="button-submit" style="width:100%;color:white; background-color: #CF8029;"
            class="btn">Send
