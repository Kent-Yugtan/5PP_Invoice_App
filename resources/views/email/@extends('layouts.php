        ...
        <div class="card-body">
          ...
          <form id="ProfileUpdate" class="g-3 needs-validation" novalidate>
            <div class="row pt-3">
              ...
              <div class="col-md-6 col-lg-6" style="display:flex;justify-content:center;align-items:center">
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group-profile">
                      ...
                      <input id="first_name" name="first_name" type="text" class="form-control" placeholder="Firstname" disabled="true" required>
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group-profile">
                      ...
                      <input id="last_name" name="last_name" type="text" class="form-control" placeholder="Lastname" disabled="true" required>
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-12 ">
                    <div id="mobileValidateEmail" class="form-group-profile">
                      ...
                      <input id="email" name="email" type="email" class="form-control" placeholder="Email" disabled="true" onblur="editValidateEmail(this)" required>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div id="mobileValidateUsername" class="form-group-profile">
                      ...
                      <input id="username" name="username" type="text" class="form-control" placeholder="Username" disabled="true" onblur="editValidateUsername(this)" required>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <select class="form-select" id="position" name="position" defaultValue="select" disabled="true" required>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <input id="phone_number" name="phone_number" type="text" class="form-control" placeholder="Phone Number" disabled="true" required maxlength="11">
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <input id="address" name="address" type="text" class="form-control" placeholder="Address" disabled="true" required>
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <input id="province" name="province" type="text" class="form-control" placeholder="Province" disabled="true" required>
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <input id="city" name="city" type="text" class="form-control" placeholder="City" disabled="true" required>
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <input id="zip_code" name="zip_code" type="text" class="form-control" placeholder="Zip Code" disabled="true" required maxlength="10">
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div id="mobileValidateAcctno" class="form-group-profile">
                      ...
                      <input id="acct_no" name="acct_no" type="text" class="form-control" placeholder="Account Number" disabled="true" onblur="editValidateAcctno(this)" required maxlength="15">
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div id="mobileValidateAcctname" class="form-group-profile">
                      ...
                      <input id="acct_name" name="acct_name" type="text" class="form-control" placeholder="Account Name" disabled="true" onblur="editValidateAcctname(this)" required>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <select class="form-select" id="bank_name" name="bank_name" aria-label="Default select example" disabled="true" required>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div class="form-group-profile">
                      ...
                      <input id="bank_address" name="bank_address" type="text" class="form-control" placeholder="Bank Address" disabled="true" required>
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 ">
                    <div id="mobileValidateGCASHno" class="form-group-profile">
                      ...
                      <input id="gcash_no" name="gcash_no" type="text" class="form-control" placeholder="Gcash Number" onblur="editValidateGCASHno(this)" disabled="true" required maxlength="11">
                ...
                <div class="row">
                  <div class="col-12 bottom10">
                    <div class="form-group-profile">
                      ...
                      <input type="text" id="date_hired" name="date_hired" class="datepicker_input form-control" autofocus="false" placeholder="Date Hired" required autocomplete="off" disabled="true">
                      <div class="invalid-feedback">This field is required.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-6 bottom20">
                    <button type="button" id="edit_profile" style="width:100%;color:white; background-color: #CF8029;" class="btn">Edit
                      Profile</button>
                    <button type="button" id="cancel_edit_profile" style="width:100%;color:#CF8029; background-color: #f3f3f3;" class="btn d-none">Cancel</button>
                  </div>
                  <div class="col-sm-6 bottom20">
                    <button type="submit" id="button-submit" style="width:100%;color:white; background-color: #CF8029;" class="btn">Save</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="tab-pane fade show active" id="pills-invoice" role="tabpanel" aria-labelledby="pills-invoice-tab">
                ...
                <div class="row">
                  <div class="col-sm-4 bottom20">
                    <button style="color:white; background-color: #CF8029;" data-bs-toggle="modal" data-bs-target="#exampleModal" type="submit" id="button-addon2" name="button-addon2" class="btn form-check-inline pe-3 w-100 "><i class="fa fa-plus pe-1"></i>Create Invoice</button>
                  </div>
                  <div class="col-sm-4 bottom20">
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div style="display:flex;justify-content:center;" class="page_showing pagination-alignment " id="tbl_showing_invoice"></div>
                    <div class="pagination-alignment" style="display:flex;justify-content:center;">
                      <ul style="display:flex;justify-content:flex-start;margin-top:15px" class="pagination pagination-sm flex-wrap" id="tbl_pagination_invoice">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane fade" id="pills-deduction" role="tabpanel" aria-labelledby="pills-deduction-tab">
                ...
                <div class="row">
                  <div class="col-sm-12 d-flex align-items-center justify-content-between">
                    <label class="d-flex align-items-center" for="deductionButton" style="color: #A4A6B3;">Deduction
                      Types</label>
                    {{-- </div>
                                        <div class="col-sm-1"> --}}
                    {{-- style="color:white; background-color: #CF8029;" --}}
                    <button type="button" id="submit-customize-create-deduction" class="border-0 bg-transparent " data-bs-toggle="modal" data-bs-target="#modal-customize-create-deduction">
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div style="display:flex;justify-content:center;" class="page_showing pagination-alignment " id="tbl_showing_deduction">
                    </div>
                    <div class="pagination-alignment" style="display:flex;justify-content:center;">
                      <ul style="display:flex;justify-content:flex-start;margin-top:15px" class="pagination pagination-sm flex-wrap" id="tbl_pagination_deduction"></ul>
                    </div>
                  </div>
                </div>
              </div>
                          ...
                          <div class="col">
                            <div class="form-group-profile">
                              <label for="due_date" style="color:#A4A6B3">Due
                                Date</label>
                              <input type="text" id="due_date" name="due_date" class="datepicker_input form-control" autofocus="false" placeholder="Due Date" required autocomplete="off" autofocus="false">
                              <div class="invalid-feedback">This field is required.</div>
                            </div>
                        ...
                        <div class="row">
                          <div class="col ">
                            <div class="form-group-profile">
                              ...
                              <input id="description" placeholder="Description" name="description" type="text" class="form-control" required>
                              <div class="invalid-feedback">This field is required.</div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-4 bottom20">
                            <div id="col_discount_amount" class="d-none">
                              <label for="discount_amount" class="label_discount_amount" style="color:#A4A6B3">Discount
                                Amount ($)</label>
                              <input type="text" step="any" style="text-align:right;" name="discount_amount" id="discount_amount" class="form-control" maxlength="6" />
                            </div>
                          </div>
                          ...
                          <div class="col-lg-12" style="justify-content:end;display:flex">
                            <div class="topBottom20" style="width: 290px !important;">
                              <div class="input-group">
                                <label class="d-flex align-items-center" for="sub_total" style="color:#A4A6B3">Subtotal
                                  ($):
                                </label>
                                <input type="text" style="font-weight: bold;text-align:right;border:none;background-color:white" name="sub_total" id="sub_total" class="form-control no-outline sub_total" tabindex="-1" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-12 col-sm-4">
                            <div>
                              <label for="dollar_amount" style="color:#A4A6B3">Dollar
                                Amount
                                ($)</label>
                              <input type="text" id="dollar_amount" style="font-weight: bold;border:none;background-color:white" class="text-start form-control dollar_amount" disabled />
                            </div>
                          </div>
                          ...
                          <div class="col-12 col-sm-4">
                            <div>
                              <label for="converted_amount" style="color:#A4A6B3">Converted
                                Amount (Php)</label>
                              <input type="text" style="font-weight: bold;border:none;background-color:white" onkeypress="return onlyNumberKey(event)" id="converted_amount" class="text-start form-control converted_amount" disabled />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12 d-flex justify-content-end">
                            <div class="input-group" style="width: 290px">
                              <label for="grand_total" class="fw-bold d-flex align-items-center">Grand
                                Total(Php):</label>
                        ...
                        <div class="col-12">
                          <div class="row ">
                            <div class="col-6 bottom20">
                              <button type="button" id="closeAddDeduction" class="btn w-100" style="color:#CF8029; background-color:#f3f3f3;" data-bs-dismiss="modal">Cancel</button>
                            </div>
                            <div class="col-6 bottom20 ">
...
<!-- OLD START MODAL ADD CREATED DEDUCTIONFOR PROFILE DEDUCTION-->
<div class="modal fade" id="modal-create-deduction" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="row " id="header">
                <div class="col-md-12  w-100">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div id="mobileValidateSelectDeductionname" class="form-group-profile">
                        ...
                        <label for="Deduction_deduction_name" style="color:#A4A6B3">Deduction
                          Name:</label>
                        <select class="Deduction_deduction_name form-select" onblur="validateSelectProfileDeduction(this)" id="Deduction_deduction_name" required>
                        </select>
                  ...
                  <div class="row">
                    <div class="col-12 bottom10">
                      <div class="form-group-profile">
                        <label for="Deduction_deduction_amount" style="color:#A4A6B3">Amount</label>
                        <input id="Deduction_deduction_amount" name="Deduction_deduction_amount" type="text" class="Deduction_deduction_amount form-control" placeholder="Amount" required>
                  ...
                  <div class="row">
                    <div class="col bottom20">
                      <button type="button" class="btn w-100" style="color:#CF8029; background-color:#f3f3f3; " data-bs-dismiss="modal">Cancel</button>
                    </div>
                    <div class="col bottom20">
                      <button type="submit" id="Deduction_button" class="btn w-100" style="color:White; background-color:#CF8029;">Add</button>
                    </div>
                  </div>
                </div>
              </div>
...
<div class="modal fade" id="modal-customize-create-deduction" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="hide-content">
      <div class="modal-body">
              ...
              <div class="row" id="header">
                <div class="col-md-12 w-100">
                  ...
                  <div class="row">
                    <div class="col-12  ">
                      <div id="mobileValidateStoreDeductionname" class="form-group-profile">
                        <div class="form-group-profile">
                          <label for="createDeduction_deduction_name" style="color:#A4A6B3">Dedution Name:</label>
                          <input id="createDeduction_deduction_name" name="createDeduction_deduction_name" type="text" class="createDeduction_deduction_name form-control" onblur="validateProfileDeduction(this)" placeholder="Deduction Name" required>
                          <div id="invalid-feedback-storeDeduction-name" class="invalid-feedback">This field is required.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-12 bottom10">
                      <div class="form-group-profile">
                        <label for="createDeduction_deduction_amount" style="color:#A4A6B3">Amount</label>
                        <input id="createDeduction_deduction_amount" name="createDeduction_deduction_amount" type="text" class="createDeduction_deduction_amount form-control" placeholder="Amount" maxlength="6" required>
                  ...
                  <div class="row">
                    ...
                    <div class="col bottom20">
                      <button type="submit" id="createDeduction_button" class="btn w-100" style="color:White; background-color:#CF8029;">Add</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row " id="header">
                  <div class="col-md-12 w-100">
                    ...
                    <div class="row">
                      <div class="col ">
                        <div id="mobileValidateDeductionname" class="form-group-profile">
                          <label for="edit_profileDeductionType_name" style="color:#A4A6B3">Profile Deduction Name</label>
                          <input type="text" id="edit_profileDeductionType_name" name="edit_profileDeductionType_name" onblur="editValidateProfileDeductionname(this)" class="form-control" required>
                    ...
                    <div class="row">
                      <div class="col ">
                        <div class="form-group-profile">
                          <label for="edit_profileDeductionType_amount" style="color:#A4A6B3">Amount</label>
                          <input id="edit_profileDeductionType_amount" name="edit_profileDeductionType_amount" type="text" class="form-control" placeholder="Amount" maxlength="6" required>
                          <div class="invalid-feedback">This field is required.</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4 bottom20">
                        <button type="button" class="btn w-100" id="cancelProfileDeduction" data-bs-dismiss="modal" style="color:#CF8029; background-color:#f3f3f3;">Cancel</button>
                      </div>
                      ...
                      <div class="col-sm-4 bottom20">
                        <button type="submit" class="btn w-100" id="profile_deduction_update" style="color:White; background-color:#CF8029; ">Update</button>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row " id="header">
                <div class="col-md-12 w-100">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          <label for="select_invoice_status" style="color:#A4A6B3">Status</label>
                    ...
                    <div class="row">
                      <div class="col bottom20">
                        <button type="button" class="btn w-100" style="color:#CF8029; background-color:#f3f3f3; " data-bs-dismiss="modal">Close</button>
                      </div>
                      <div class="col bottom20">
...
<!-- Modal FOR DELETE -->
<div class="modal fade" style="z-index: 999999" id="deleteModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<div class="modal fade" id="previewModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" data-bs-keyboard="false">
    ...
    $(document).on('click', '.remove_items', function(e) {
      ...
      if (row_item) {
        ...
        $.confirm({
          ...
          draggable: false,
          title: 'Are you sure?',
          content: '<div class="row"><div class="col text-center"><img class="" src="{{ asset('
          images / Delete.png ') }}" style="width: 50%; padding:10px" /></div></div><div class="row"><div class="col text-center"><label>Do you really want to delete this record? This process cannot be undone.<label></div></div>',
