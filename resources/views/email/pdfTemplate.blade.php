                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @elseif($content['payment_status'] === 'Overdue')
                                    <td class="left-radius" style="color:#dc3545;vertical-align:top;"><strong>Invoice
                                            Status:</strong></td>
                                    <td class="right-radius" style="vertical-align:top;color:#dc3545;text-align: end;">
                                        <strong> {{ $content['payment_status'] }}</strong>
                                    </td>
                                @else
                                    <td class="left-radius" style="color:#ffc107;vertical-align:top;"><strong>Invoice
                                            Status:</strong></td>
                  ...
                  {{ $content['zip_code'] }} -->
                    ...
                    <table class="table2" style="table-layout: fixed; width: 100%">
                        ...
                        <tbody>
                            @foreach ($content['invoice_items'] as $items)
                                <tr>
                                    <td class="scope" style="text-align:left;word-wrap: break-word">
                                        {{ $items->item_description }}</td>
                                    <td class="scope" style="text-align:right;">{{ $items->quantity }}</td>
                                    <td class="scope" style="text-align:right;">${{ number_format($items->rate, 2) }}
                                    </td>
                                    <td class="scope" style="text-align:right;">
                    ...
                    <table class="table3" style="table-layout: fixed; width: 100%">
                        <tbody>
                            ...
                            <tr>
                                <td style="width:100%"><strong>Converted Amount: P{{ $content['peso_rate'] }}</strong>
                                </td>
