                    ...
                    <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            <td class="email-body" width="470" cellpadding="0" cellspacing="0"
                                ...
                                <table class="email-body_inner" align="center" width="470" cellpadding="0"
                                    cellspacing="0" role="presentation"
                                    style="width: 470px; -premailer-width: 470px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF; margin: 0 auto; padding: 0;"
                                    bgcolor="#FFFFFF">
                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <div class="f-fallback">
                                                ...
                                                <p
                                                    style="text-align: justify;font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                                                    We are received a request to reset the password for <b>5 Pints
                                                        Productions Invoice</b> account
                                                    associated with {{ $content['to'] }} you can reset your password by
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                                        <a target="_blank"
                                                                            href=" {{ $content['action_link'] }}/{{ $content['token'] }}?email_address={{ $content['to'] }}"
                                                                            class="f-fallback button button--green"
                                                                            target="_blank"
                                                                            style="color: #FFF; border-color: #CF8029; border-style: solid; border-width: 10px 18px; background-color: #CF8029; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Reset
                                                                            your password</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <p class="f-fallback sub"
                                                                ...
                                                                If
                                                                you’re having trouble with the button above, copy and
                        ...
                        <tr>
                            <td
                                style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                <table class="email-footer" align="center" width="470" cellpadding="0"
                                    cellspacing="0" role="presentation"
                                    style="width: 470px; -premailer-width: 470px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; text-align: center; margin: 0 auto; padding: 0;">
                                    <tr>
                                        <td class="content-cell" align="center"
                                            style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                                            <p class="f-fallback sub align-center"
                                                style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;"
                                                align="center">Copyright &copy; 5Pints Productions All rights reserved.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
